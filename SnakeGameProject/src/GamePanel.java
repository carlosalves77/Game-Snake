...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void checkCollisions() {
        ...
        // Verifica se a cabeça toca na esquerda da barda
        if(x[0] < 0) {
            running = false;
        }
        // verifica se a cabeça toca na direita da borda
        if(x[0] > SCREEN_WIDTH) {
            running = false;
        }
        // verifica se a cabeça toca no topo da borda
        if(y[0] < 0) {
            running = false;
        }
        // verifica se a cabeça toca embaixo da borda
